...
// Bubber has added bellies. Normally this would make me delete most of this code,
// but I feel nostalgic about it so it gets to live. Unless Metis
// tells me to axe it or someone else does it.
