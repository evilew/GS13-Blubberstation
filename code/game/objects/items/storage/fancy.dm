...
/obj/item/storage/fancy/donut_box
	name = "donut box"
	desc = "Mmm. Donuts."
	icon = 'modular_gs/icons/obj/food/containers.dmi'	// GS13 EDIT big fat obese massive soft belly gatoification from clumpert	icon = 'icons/obj/food/donuts.dmi'
...
/obj/item/storage/fancy/donut_box/update_overlays()
	...
	for(var/_donut in contents)
		...
		var/image/donut_image = image(icon = 'icons/obj/food/donuts.dmi', icon_state = donut.in_box_sprite())	// GS13 EDIT - gatoifies donut boxes. This used to use initial icon state but to not re-use the donut sprites, I just have it reference the original texture		var/image/donut_image = image(icon = initial(icon), icon_state = donut.in_box_sprite())
