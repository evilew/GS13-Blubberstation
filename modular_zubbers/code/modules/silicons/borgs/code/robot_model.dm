...
/obj/item/robot_model/centcom
	...
	borg_skins = list(
		...
		/* GS13 EDIT THE AGE OF QUADBORGS HAS ENDED
		"Raptor" = list(
...
/obj/item/robot_model/sci
	...
	borg_skins = list(
		...
		/* GS13 EDIT FOLLOW ME, AND WE WILL NEVER HAVE QUADBORGS AGAIN
		"Raptor" = list(
			SKIN_ICON_STATE = CYBORG_ICON_TYPE_RAPTOR,
		...
		/* GS13 EDIT RIIIIIIIIIIIIIIIIIISEEEEEEEEEEEE UUUUUUUUUUUUUPPPPP
		"K1-T7Y" = list(
			SKIN_ICON_STATE = "sci",
		...
		"Dragon" = list(
			...
			SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUEPANEL, TRAIT_R_HAS_UNIQUE_RESTING_LIGHTS, /* GS13 EDIT TRAIT_R_EXPANDER_BLOCKED*/, TRAIT_R_BIG)
		),
		/* GS13 EDIT
		"Myomer" = list(
...
/obj/item/robot_model/medical/Initialize(mapload)
	...
	borg_skins |= list(
		...
		/* GS13 EDIT I'm running out of things to yell at the quadborgs as I strike them all down
		"K1-T7Y" = list(
...
/obj/item/robot_model/janitor/Initialize(mapload)
	...
	borg_skins |= list(
		...
		/* GS13 EDIT getting rid of quadborgs
		"K1-T7Y" = list(
...
/obj/item/robot_model/miner/Initialize(mapload)
	...
	borg_skins |= list(
		...
		/* GS13 EDIT removing quadborgs goes brrrrrrrrrrr
		"Myomer" = list(
...
/obj/item/robot_model/security/Initialize(mapload)
	...
	borg_skins |= list(
		...
		/* GS13 EDIT seriously I ran out of funny juice
		//64x48 sprites below (Raptor)
		"Raptor" = list(
			SKIN_ICON_STATE = CYBORG_ICON_TYPE_RAPTOR,
